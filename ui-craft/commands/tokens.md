---
description: Audit or establish the project's 3-layer token spine.
argument-hint: "[optional: 'audit', 'establish', or specific category — color | spacing | type | radii | shadows | motion | z-index]"
---
